...
class Vector(VectorBase):
    ...
    def analyze(self) -> None:
        ...
        if dangerous_custom_permissions:
            self.writer.startWriter("PERMISSION_DANGEROUS", LEVEL_CRITICAL,
                                    ...
                                    "Please check some related cases.")
    ...
    Related Cases: See CVE-2013-6272 for more details.""", None, "CVE-2013-6272")
    ...
    Vulnerable ContentProvider Case Example: See CVE related to ContentProvider vulnerabilities
    """)
