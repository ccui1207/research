...
"""
	*****************************************************************************
	** APKScanner Framework - Android App Security Vulnerability Scanner        **
	*****************************************************************************
	...
	** Read Python codeing style first: http://www.python.org/dev/peps/pep-0008/ **
	...
	3.Use command 'grep -nFr "#Added by APKScanner" *' to see what APKScanner Framework has added to Androguard Open Source project under "tools/modified/androguard" root directory.
	...
	APKScanner Framework is supported with MongoDB. Add "-s" argument if you want all the analysis results to be stored into the MongoDB.
...
def main():
    parser = argparse.ArgumentParser(description='APKScanner Framework - Android App Security Vulnerability Scanner')
