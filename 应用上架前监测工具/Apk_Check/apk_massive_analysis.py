...
def parseArgument():
    parser = argparse.ArgumentParser(
        description='APKScanner Framework: Android APK Vulnerability Scanner - Massive Tool')
...
def main():
    ...
    print()
    print("## APKScanner Framework: Android APK Vulnerability Scanner - Massive Tool ##")
    print()
