...
def parseArgument():
	parser = argparse.ArgumentParser(description='APKScanner Framework: Android APK Vulnerability Summary Reporter (Parameter Condition: and)')
...
print("## APKScanner Framework: Android APK Vulnerability Summary Reporter ##")
print()

if platform.system().lower() == "windows" :
	print("[Notice] The output format is not good in Windows console")

db_config_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'apkscanner-db.cfg')
