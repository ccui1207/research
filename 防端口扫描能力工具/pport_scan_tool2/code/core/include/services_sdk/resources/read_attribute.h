...
#define __READ_ATTRIBUTE_H__

#include "intelligence_is/data_string.h"
...
public:
    ...
    std::map<std::string, std::string> getMainAttributes() const;
...
#include "intelligence_is/read_attribute_impl.h"
